...
public class TreeWriter {
    ...
    public void addStartElement(XdmNode node, QName newName, URI overrideBaseURI, AttributeMap attrs) {
        ...
        addStartElement(newNameOfNode, attrs, inode.getSchemaType(), inscopeNS, node.getLineNumber());
    }
    ...
    public void addStartElement(NodeName elemName, AttributeMap attrs, SchemaType typeCode, NamespaceMap nsmap) {
        addStartElement(elemName, attrs, typeCode, nsmap, -1);
    }

    public void addStartElement(NodeName elemName, AttributeMap attrs, SchemaType typeCode, NamespaceMap nsmap, int lineNumber) {
        ...
        if (sysId == null) {
            ...
            loc = new Loc(sysId, lineNumber, -1);
        }
